...
@Component({
    template: `
        <app-error-401 [someInput]="someInput" (someFunction)="someFunction($event)"></app-error-401>
    `,
})
...
describe('Error401Component', () => {
    ...
    it('should display the component', () => {
        expect(hostComponentNE.querySelector('app-error-401')).toEqual(jasmine.anything());
    });
});
